---
title: "Part 3: Regression Models - Model 11"
...
#svmRadial %>% coefplot::coefplot() + theme_bw() + theme(legend.position='none')
```

```{r}
pred_y <- predict(svmRadial, efm_df)
...
```{r}
svmRadial %>% readr::write_rds("part_3_model_11.rds")
```

```{r}
re_load_lm_11 <- readr::read_rds("part_3_model_11.rds")
re_load_lm_11 %>% summary()
```
