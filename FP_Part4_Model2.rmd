---
title: "Part 4: Regression Models - Model 2"
...
This model did a bit better, with an accuracy of ~69%.


This is not better than the empirical event proportion of about 64%.
...
```{r}
glm_add_res_ef %>% readr::write_rds("part_4_model_2.rds")
```

```{r}
re_load_p4_m2 <- readr::read_rds("part_4_model_2.rds")
re_load_p4_m2 %>% summary()
```
