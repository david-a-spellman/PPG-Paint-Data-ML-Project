---
title: "Part 4: Regression Models - Model 6"
...
##2. The most complex model you tried in Part ii)
...
```{r}
enet_p4_m6 %>% readr::write_rds("part_4_model_6.rds")
```

```{r}
re_load_p4_m6 <- readr::read_rds("part_4_model_6.rds")
re_load_p4_m6 %>% summary()
```
