---
title: "Part 4: Regression Models - Model 10"
...
```{r}
pls_p4_m10 %>% readr::write_rds("part_4_model_10.rds")
```

```{r}
re_load_p4_m10 <- readr::read_rds("part_4_model_10.rds")
```
