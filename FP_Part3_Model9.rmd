---
title: "Part 3: Regression Models - Model 9"
...
#xgbTree %>% coefplot::coefplot() + theme_bw() + theme(legend.position='none')
```
...
```{r}
xgbTree %>% readr::write_rds("part_3_model_9.rds")
```

```{r}
re_load_lm_9 <- readr::read_rds("part_3_model_9.rds")
re_load_lm_9 %>% summary()
```
