---
title: "Part 3: Regression Models - Model 8"
...
#randf %>% coefplot::coefplot() + theme_bw() + theme(legend.position='none')
```

```{r}
pred_y <- predict(randf, efm_df)
...
```{r}
randf %>% readr::write_rds("part_3_model_8.rds")
```

```{r}
re_load_lm_8 <- readr::read_rds("part_3_model_8.rds")
re_load_lm_8 %>% summary()
```
