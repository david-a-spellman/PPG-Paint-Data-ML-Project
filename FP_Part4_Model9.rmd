---
title: "Part 4: Regression Models - Model 9"
...
xgbTree_p4_m9 %>% summary()
```

```{r}
xgbTree_p4_m9 %>% readr::write_rds("part_4_model_9.rds")
```

```{r}
re_load_p4_m9 <- readr::read_rds("part_4_model_9.rds")
re_load_p4_m9 %>% summary()
```
